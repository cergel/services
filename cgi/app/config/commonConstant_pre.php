...
defined('JAVA_ADDR_USERCENTER_UCOPEN') or define('JAVA_ADDR_USERCENTER_UCOPEN', 'http://10.104.140.34:8101');
//defined('JAVA_ADDR_INTRA_USERCENTER') or define('JAVA_ADDR_INTRA_USERCENTER', 'http://10.66.154.209');

//商品中心(齐磊)
defined('JAVA_ADDR_TICKET_WX') or define('JAVA_ADDR_TICKET_WX', 'http://10.104.1.55:8181');
defined('JAVA_ADDR_TICKET_CHANNEL') or define('JAVA_ADDR_TICKET_CHANNEL', 'http://10.104.1.55:8181');
defined('JAVA_ADDR_SCHEDULE') or define('JAVA_ADDR_SCHEDULE', 'http://10.250.168.15:8080');

//营销相关——红包(郭朝伟)
defined('JAVA_ADDR_BONUS_WX') or define('JAVA_ADDR_BONUS_WX', 'http://10.104.0.247:8181');
defined('JAVA_ADDR_BONUS_CHANNEL') or define('JAVA_ADDR_BONUS_CHANNEL', 'http://10.104.0.247:8181');
//营销相关——兑换券(郭朝伟)
defined('JAVA_ADDR_EXCHANGE_WX') or define('JAVA_ADDR_EXCHANGE_WX', 'http://10.104.0.247:8088');
defined('JAVA_ADDR_EXCHANGE_CHANNEL') or define('JAVA_ADDR_EXCHANGE_CHANNEL', 'http://10.104.0.247:8088');
//营销相关——礼品卡(郭朝伟)
defined('JAVA_ADDR_GIFT_CARD_WX') or define('JAVA_ADDR_GIFT_CARD_WX', 'http://10.104.0.247:8181');
defined('JAVA_ADDR_GIFT_CARD_CHANNEL') or define('JAVA_ADDR_GIFT_CARD_CHANNEL', 'http://10.104.0.247:8181');
//排期接口（郭朝伟）
defined('JAVA_ADDR_SCHE_WX') or define('JAVA_ADDR_SCHE_WX', 'http://10.104.0.247:8181');
defined('JAVA_ADDR_SCHE_CHANNEL') or define('JAVA_ADDR_SCHE_CHANNEL', 'http://10.104.0.247:8181');

//订单相关(童书键)
defined('JAVA_ADDR_ORDER_WX') or define('JAVA_ADDR_ORDER_WX', 'http://10.104.6.34:8082');
defined('JAVA_ADDR_ORDER_CHANNEL') or define('JAVA_ADDR_ORDER_CHANNEL', 'http://10.104.6.34:8082');
...
//大数据-明星配对
defined('JAVA_ADDR_BIG_DATA_STAR_PAIR') or define('JAVA_ADDR_BIG_DATA_STAR_PAIR', 'http://10.135.90.92:8083/star/pairing');
defined('JAVA_ADDR_BIG_DATA_STAR_PAIR_PV') or define('JAVA_ADDR_BIG_DATA_STAR_PAIR_PV', 'http://10.135.90.92:8083/star/pv');
//媒资库接口（刘龙）//预上线接口
...
defined('JAVA_ES_SEARCH_DATABASES') or define('JAVA_ES_SEARCH_DATABASES', 'http://10.104.88.207:8081');
//新综合搜索(苏利军)包含影片、影院、排期,因为是根据端口号来区分的，所以就直接写在这了
defined('JAVA_ES_SEARCH_MORE') or define('JAVA_ES_SEARCH_MORE', 'http://10.135.90.92:8081/v2/search/integrate');
//格瓦拉 影片维度影院搜索排序接口
defined('JAVA_ES_SEARCH_CINEMASMOV') or define('JAVA_ES_SEARCH_CINEMASMOV', 'http://10.104.88.207:8083/gewara/search/cinemasmov_sort');
//卖品（齐磊）
defined('JAVA_ADDR_SNACK_WX') or define('JAVA_ADDR_SNACK_WX', 'http://snack.pre.ns.wepiao.com');
defined('JAVA_ADDR_SNACK_CHANNEL') or define('JAVA_ADDR_SNACK_CHANNEL', 'http://snack.pre.ns.wepiao.com');
//商品中心不可售和自有库存座位接口
defined('JAVA_UNSOLD_SEATS_AND_LOCAL_SEATS_WX') or define('JAVA_UNSOLD_SEATS_AND_LOCAL_SEATS_WX', 'http://10.104.1.55:8084');
defined('JAVA_UNSOLD_SEATS_AND_LOCAL_SEATS_CHANNEL') or define('JAVA_UNSOLD_SEATS_AND_LOCAL_SEATS_CHANNEL', 'http://10.104.1.55:8084');
...
//大数据影院列表接口
defined('JAVA_ADDR_BIG_DATA_CINEMA_LIST_SEARCH_WX') or define('JAVA_ADDR_BIG_DATA_CINEMA_LIST_SEARCH_WX', "http://10.104.88.207:8083");
defined('JAVA_ADDR_BIG_DATA_CINEMA_LIST_SEARCH_CHANNEL') or define('JAVA_ADDR_BIG_DATA_CINEMA_LIST_SEARCH_CHANNEL', "http://10.104.88.207:8083");
defined('PEOMOTION_CDN_URL') or define('PEOMOTION_CDN_URL', "https://promotion-pre.wepiao.com");//promotion地址

//营销相关——卖品优惠(郭朝伟)
defined('JAVA_ADDR_SNACK_DISCOUNT_WX') or define('JAVA_ADDR_SNACK_DISCOUNT_WX', 'http://promotion-pre.testslb.wepiao.com');
defined('JAVA_ADDR_SNACK_DISCOUNT_CHANNEL') or define('JAVA_ADDR_SNACK_DISCOUNT_CHANNEL', 'http://promotion-pre.testslb.wepiao.com');

//会员卡(杨伟平)
defined('JAVA_ADDR_CINEMA_VIP_WX') or define('JAVA_ADDR_CINEMA_VIP_WX', "http://10.104.6.34:8083");
defined('JAVA_ADDR_CINEMA_VIP_CHANNEL') or define('JAVA_ADDR_CINEMA_VIP_CHANNEL', "http://10.104.6.34:8083");

//大数据影院列搜索(苏利军)
defined('JAVA_ADDR_BIG_DATA_CINEMA_INFO_SEARCH_WX') or define('JAVA_ADDR_BIG_DATA_CINEMA_INFO_SEARCH_WX', "http://10.104.88.207:8081");
defined('JAVA_ADDR_BIG_DATA_CINEMA_INFO_SEARCH_CHANNEL') or define('JAVA_ADDR_BIG_DATA_CINEMA_INFO_SEARCH_CHANNEL', "http://10.104.88.207:8081");

//商品中心——数据中心(齐磊)
defined('JAVA_ADDR_CORE_DATA_WX') or define('JAVA_ADDR_CORE_DATA_WX', "http://10.251.209.50:8083");
defined('JAVA_ADDR_CORE_DATA_CHANNEL') or define('JAVA_ADDR_CORE_DATA_CHANNEL', "http://10.251.209.50:8083");
...
//格瓦拉支付(佟书建)
defined('JAVA_PAY_GEWARA') or define('JAVA_PAY_GEWARA', "http://10.104.2.237:8501");
defined('JAVA_PAY_GEWARA_BUSINESS_KEY') or define('JAVA_PAY_GEWARA_BUSINESS_KEY','PpVNcS1H2vjsXr8w5f9sXTGYAIBlQF6D');
//银河  商业化接口
defined("SYH_PHP_BONUS_URL_API") or define("SYH_PHP_BONUS_URL_API", 'apiprebiz.wepiao.com');
...
//滑动验证H5页面的url
defined('SLIDE_H5_URL') or define('SLIDE_H5_URL', "http://module.wepiao.com/captcha/");
//判断当前运行环境
defined('SERVICE_ENV') or define('SERVICE_ENV', "pre");
//评论中心
defined('COMMENT_CENTER_URL') or define('COMMENT_CENTER_URL', 'http://10.251.106.228:8090');
//NFS地址
