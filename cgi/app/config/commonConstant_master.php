...
//营销相关——红包(郭朝伟)
defined('JAVA_ADDR_BONUS_WX') or define('JAVA_ADDR_BONUS_WX', 'http://10.66.139.144:80');
defined('JAVA_ADDR_BONUS_CHANNEL') or define('JAVA_ADDR_BONUS_CHANNEL', 'http://10.66.139.144:80');
//营销相关——兑换券(郭朝伟)
...
//营销相关——礼品卡(郭朝伟)
defined('JAVA_ADDR_GIFT_CARD_WX') or define('JAVA_ADDR_GIFT_CARD_WX', 'http://10.66.139.144:80');
defined('JAVA_ADDR_GIFT_CARD_CHANNEL') or define('JAVA_ADDR_GIFT_CARD_CHANNEL', 'http://10.66.139.144:80');
//排期接口（郭朝伟）
...
//订单相关(童书键)
defined('JAVA_ADDR_ORDER_WX') or define('JAVA_ADDR_ORDER_WX', 'http://ordercenter.grammy.wxmovie.com:80');
defined('JAVA_ADDR_ORDER_CHANNEL') or define('JAVA_ADDR_ORDER_CHANNEL', 'http://ordercenter.grammy.wxmovie.com:80');
defined('JAVA_WATCH_SAME_MOVIES') or define('JAVA_WATCH_SAME_MOVIES', 'http://10.3.10.26/v2/usertag/movie/getCommonMoives');//共同看过的电影
...
//营销相关——卖品优惠(郭朝伟)
defined('JAVA_ADDR_SNACK_DISCOUNT_WX') or define('JAVA_ADDR_SNACK_DISCOUNT_WX', 'http://promotion-yx.wepiao.com');
defined('JAVA_ADDR_SNACK_DISCOUNT_CHANNEL') or define('JAVA_ADDR_SNACK_DISCOUNT_CHANNEL', 'http://promotion-yx.wepiao.com');
...
//商品中心——数据中心(齐磊)
defined('JAVA_ADDR_CORE_DATA_WX') or define('JAVA_ADDR_CORE_DATA_WX', "http://data-core.wp.wepiao.com");
defined('JAVA_ADDR_CORE_DATA_CHANNEL') or define('JAVA_ADDR_CORE_DATA_CHANNEL', "http://data-core-qd.wepiao.com");
...
//格瓦拉支付(佟书建)
defined('JAVA_PAY_GEWARA') or define('JAVA_PAY_GEWARA', "http://pay.intra.wepiao.com");
...
//判断当前运行环境
defined('SERVICE_ENV') or define('SERVICE_ENV', "master");
//评论中心
defined('COMMENT_CENTER_URL') or define('COMMENT_CENTER_URL', 'http://comment.intra.wepiao.com');
//NFS地址
defined('NFS_HOST') or define('NFS_HOST', 'https://appnfs.wepiao.com/');
...
//格瓦拉侧内部接口地址
defined('GEWARA_URL') or define('GEWARA_URL', 'http://gwtm.wepiao.com');
